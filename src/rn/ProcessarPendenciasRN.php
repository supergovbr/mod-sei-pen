  ...
  private function inicializarGearman()
    ...
    if(!class_exists("GearmanWorker")) {
        throw new InfraException(
            "Não foi possível localizar as bibliotecas do PHP para conexão ao GEARMAN./n" .
  ...
  private static function verificarGearmanAtivo($parStrServidor, $parStrPorta)
    ...
    try {
      if(!class_exists("GearmanClient")) {
        throw new InfraException(
            "Não foi possível localizar as bibliotecas do PHP para conexão ao GEARMAN (GearmanClient). " .
            "Verifique os procedimentos de instalação do mod-sei-pen para maiores detalhes"
        );
      }
      ...
      if(!class_exists("GearmanWorker")) {
          throw new InfraException(
              "Não foi possível localizar as bibliotecas do PHP para conexão ao GEARMAN (GearmanWorker). " .
              "Verifique os procedimentos de instalação do mod-sei-pen para maiores detalhes"
          );
      }
